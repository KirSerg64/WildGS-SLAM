    ...
    int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(volume.simple_type(), "sampler_forward_kernel", ([&] {
  ...
  int radius)
{
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(volume.simple_type(), "sampler_backward_kernel", ([&] {
